...
type ContainerScrollSubcomponents = {
	Header: typeof Header;
	Card: typeof Card;
};

const ContainerScroll: React.FC<ContainerScrollProps> &
	ContainerScrollSubcomponents = (props) => {
...
const Header: React.FC<ContainerScrollHeaderProps> = (props) => {
...
Header.displayName = 'ContainerScroll.Header';
ContainerScroll.Header = Header;
...
const Card: React.FC<ContainerScrollCardProps> = (props) => {
...
Card.displayName = 'ContainerScroll.Card';
ContainerScroll.Card = Card;
